...
def record_and_save_audio():
    ...
    recording_thread = threading.Thread(target=record_audio, args=(stream, audio_buffer, CHUNK, CHANNELS, is_recording))
            ...
            while True:
                ...
                try:
                    ...
                    if request == b'REQUEST':
                        ...
                        saved_filepath = save_audio(audio_data, CHANNELS, RATE, SAVE_DIR)
